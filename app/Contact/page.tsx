        ...
        <div className="max-w-7xl mx-auto mt-8">
          ...
          <div className="text-center mb-8">
            <h1 className="font-semibold text-2xl md:text-4xl">
              <span className="text-[#4BC59E]">Ge</span>t In Touch With Us
            </h1>
          ...
          <div className="grid lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-8">
              ...
              <div className="flex items-start">
                <IoLocation className="w-8 h-8 text-[#4BC59E]" />
                <div className="ml-4">
              ...
              {/* Phone Box */}
              <div className="flex items-start">
                <FaPhoneAlt className="w-8 h-8 text-[#4BC59E]" />
                <div className="ml-4">
              ...
              {/* Working Hours */}
              <div className="flex items-start">
                <FaClock className="w-8 h-8 text-[#4BC59E]" />
                <div className="ml-4">
              ...
              <form className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-[#4BC59E] focus:border-[#4BC59E]"
                  />
                </div>
                {/* Email */}
                <div>
                ...
                <button className="w-full py-3 bg-[#4BC59E] text-white rounded-lg shadow ">
                  Submit
                </button>
              </form>
            </div>
          ...
          <div className="bg-gray-100 mt-16 py-10">
            <div className="max-w-7xl mx-auto grid md:grid-cols-3 gap-6">
              ...
              <div className="flex items-center">
                <HiOutlineTrophy className="w-12 h-12 text-[#4BC59E]" />
                <div className="ml-4">
              ...
              {/* Feature Box 2 */}
              <div className="flex items-center">
                <LuBadgeCheck className="w-12 h-12 text-[#4BC59E]" />
                <div className="ml-4">
              ...
              {/* Feature Box 3 */}
              <div className="flex items-center">
                <MdSupportAgent className="w-12 h-12 text-[#4BC59E]" />
                <div className="ml-4">
